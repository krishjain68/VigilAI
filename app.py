...
# ─────────────────────────────────────────────────────────────
st.set_page_config(
    page_title="🚨 VigilAI Crime Intelligence",
    page_icon="🚨",
    layout="wide",
...
# HEADER
# ─────────────────────────────────────────────────────────────
st.markdown("# 🚨 VigilAI — Crime Intelligence Dashboard")
...
with tab1:
    ...
    if not spikes_df.empty:
        ...
        def color_type(val):
            ...
            return ""
        st.dataframe(
          styled.style.map(color_type, subset=["Type"]),
...
st.markdown(
    ...
    "🚨 VigilAI Crime Intelligence Platform &nbsp;|&nbsp; "
